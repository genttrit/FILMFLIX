...
import './CardMovieSearch.scss'


function CardMovieSearch({movie, username, handleDetailsPopUp,handleFavoriteMoviesButton}) {
    ...
    return (
        ...
        <h3 style={{color: 'azure', 
                    width: '300px'
        }}className='CardMovieSearchTitle'>{movie.title} - {movie.release_date.slice(0, 4)}</h3>
        </div>
    )
}
